...
func WithH264MediaEngine(clockrate uint32, packetisationMode PacketisationMode, profileLevelID ProfileLevel) SinksOptions {
	return func(sinks *Sinks) error {
		if err := sinks.mediaEngine.RegisterCodec(webrtc.RTPCodecParameters{
